...
sdlmsg_t * sdlmsg_hook_keyboard(sdlmsg_t * msg, unsigned char pressed, unsigned int key) {
	sdlmsg_hook_keyboard_t *msgk = (sdlmsg_hook_keyboard_t*)msg;
	bzero(msg, sizeof(sdlmsg_hook_keyboard_t));
	msgk->msgsize = htons(sizeof(sdlmsg_hook_keyboard_t));
	msgk->msgtype = SDL_EVENT_MSGTYPE_HOOK_KEYBOARD;
	msgk->is_pressed = pressed;
	msgk->keyCode = key;
	return msg;
}
